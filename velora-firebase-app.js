...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .wa-float:hover { transform: translateY(-3px) scale(1.05); box-shadow: 0 10px 32px rgba(37,211,102,0.55); }
...
<a class="wa-float" onclick="openWhatsAppAdmin('Halo Admin Velora, saya ingin bertanya tentang sewa papan ucapan.')" title="Hubungi Admin via WhatsApp">
  <span class="wa-float-tooltip">Hubungi Admin</span>
...
<div id="page-home" class="page active">
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:20px;margin-bottom:48px;">
      ...
      <div style="background:var(--white);border-radius:20px;padding:28px 20px;text-align:center;box-shadow:var(--shadow);">
        <div style="font-size:2.4rem;margin-bottom:12px;">🎀</div>
        <div style="font-family:'Playfair Display',serif;font-size:1rem;margin-bottom:6px;">Papan Gantung</div>
        <div style="font-size:.82rem;color:var(--muted);">Papan cantik dengan gantungan bunga; tersedia warna pink & merah</div>
      </div>
      <div style="background:var(--white);border-radius:20px;padding:28px 20px;text-align:center;box-shadow:var(--shadow);">
        <div style="font-size:2.4rem;margin-bottom:12px;">🌸</div>
    ...
    <div style="overflow-x:auto;margin-bottom:40px;">
      <table style="border-radius:16px;overflow:hidden;box-shadow:var(--shadow);background:var(--white);width:100%;">
        ...
        <tbody id="price-tbody">
          <tr><td>Sidang</td><td style="color:var(--pink-deep);font-weight:600">Rp 85.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 55.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 85.000</td></tr>
          <tr><td>Wedding</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 65.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td></tr>
          <tr><td>Lamaran</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 65.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td></tr>
          <tr><td>Event</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 65.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td></tr>
        </tbody>
      </table>
    </div>
  </div>
...
<div id="page-gallery" class="page">
  <div class="container">
    ...
    <div class="gallery-grid">
      ...
      <div class="gallery-card">
        <img src="assets/foto6.jpeg" alt="Papan Gantung">
        <div class="caption">Papan Gantung 🎀 · Pink & Merah · Tersedia</div>
      </div>
    </div>
    ...
    <div class="note-box" style="margin-top:12px;max-width:480px;margin-left:auto;margin-right:auto;background:#fff0f4;border-color:#e87fa0;">
      🎀 <strong>Papan Gantung:</strong> Untuk papan gantung, warna bunga yang tersedia hanya <strong>Pink</strong> dan <strong>Merah</strong>.
    </div>
  </div>
</div>
    ...
    <div class="form-card">
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <select id="f-warna" onchange="checkWarnaGantung()">
          ...
          <div id="warna-gantung-note" style="display:none;font-size:.78rem;color:var(--pink-deep);margin-top:4px;">⚠️ Papan Gantung hanya tersedia warna <strong>Pink</strong> dan <strong>Merah</strong></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group full">
          ...
          <select id="f-papan" onchange="updatePrice(); checkWarnaGantung()">
            ...
            <option value="Papan Gantung">Papan Gantung 🎀 (Bunga: Pink & Merah only)</option>
          </select>
        </div>
      ...
      <div class="payment-box">
        ...
        <div class="bank-row">
          <div class="bank-info">
            ...
            <div class="account">901335307677 (A.n Saifullah)</div>
          </div>
          <button class="copy-btn" onclick="copyText('901335307677')">Salin Nomor</button>
        </div>
        <div class="bank-row">
          <div class="bank-info">
            <div class="bank-name">DANA</div>
            <div class="account">085747480993 (A.n Saifullah)</div>
          </div>
          <button class="copy-btn" onclick="copyText('085747480993')">Salin Nomor</button>
        </div>
        <p class="payment-nb">
  ...
  <div class="container">
    <div class="success-card">
      ...
      <div class="payment-box" style="margin-top:16px;">
        <h4>💳 Transfer DP/Pelunasan ke</h4>
        <div class="bank-row">
          <div class="bank-info"><div class="bank-name">SeaBank</div><div class="account">901335307677 (A.n Saifullah)</div></div>
          <button class="copy-btn" onclick="copyText('901335307677')">Salin</button>
        </div>
        <div class="bank-row">
          <div class="bank-info"><div class="bank-name">DANA</div><div class="account">085747480993 (A.n Saifullah)</div></div>
          <button class="copy-btn" onclick="copyText('085747480993')">Salin</button>
        </div>
      </div>
...
<div id="page-admin" class="page">
  <div class="admin-wrap">
    ...
    <!-- Price Manager -->
    <div class="stock-mgr" style="margin-top:24px;">
      <h3>💰 Kelola Harga Sewa</h3>
      <p style="font-size:.83rem;color:var(--muted);margin-bottom:16px;">Ubah harga sewa untuk setiap jenis papan dan acara. Perubahan langsung diterapkan ke halaman pelanggan.</p>
      <div id="price-input-wrap"></div>
      <button class="btn btn-pink" style="margin-top:8px;font-size:.85rem;" onclick="savePrices()">💾 Simpan Harga</button>
    </div>
...
<script src="velora-firebase-app.js"></script>
</body>
</html>
