  ...
  <div class="container">
    ...
    <div style="overflow-x:auto;margin-bottom:40px;">
      <table style="border-radius:16px;overflow:hidden;box-shadow:var(--shadow);background:var(--white);width:100%;">
        ...
        <tbody>
          <tr><td>Sidang</td><td style="color:var(--pink-deep);font-weight:600">Rp 85.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 55.000</td></tr>
          <tr><td>Wedding</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 65.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td></tr>
          <tr><td>Lamaran</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 65.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td></tr>
          <tr><td>Event</td><td style="color:var(--pink-deep);font-weight:600">Rp 100.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 65.000</td><td style="color:var(--pink-deep);font-weight:600">Rp 60.000</td></tr>
        </tbody>
      </table>
    </div>
  </div>
    ...
    <div class="form-card">
      <div class="form-grid">
        ...
        <div class="form-group full">
          ...
          <select id="f-papan" onchange="updatePrice()">
